...
module.exports = (sequelize) => sequelize.define('ContractStatusHistory', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  contract_id: { type: DataTypes.INTEGER, allowNull: false, comment: '合同ID' },
...
}, { tableName: 'contract_status_histories', timestamps: true, underscored: false, createdAt: 'created_at', updatedAt: false });
